  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        ...
        <Link href="/dashboard/appointments/new"><Button size="sm">Nuevo turno</Button></Link>
      </div>
      {appointments?.length ? (
        <div className="grid grid-cols-1 gap-3">
          {appointments.map((a: any) => (
            <Card key={a.id} className="transition-transform duration-200 hover:-translate-y-0.5 hover:shadow-md">
              <div className="flex items-center justify-between">
                <div>
